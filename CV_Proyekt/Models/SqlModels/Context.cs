...
namespace CV_Proyekt.Models.SqlModels
{
    public class Context : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer("Data Source=104.247.162.242\\MSSQLSERVER2019 initial catalog=webigemc_SapakCV; User=webigemc_SapakCV; Password:Muhammet1; Integrated Security=true;TrustServerCertificate=True;");
        }

        public DbSet<AboutMeData> AboutMeDatas { get; set; }
